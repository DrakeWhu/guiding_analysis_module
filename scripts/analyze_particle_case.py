...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "For --which exit, abort unless the selected particle iteration is "
            "within this many steps of the guiding iteration nearest the physical "
            "exit. Omit for legacy nearest-snapshot behavior."
        ),
    )
